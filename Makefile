...
INCLUDES=-I.. -I$(HL2SDK)/public -I$(HL2SDK)/public/engine -I$(HL2SDK)/public/mathlib -I$(HL2SDK)/public/vstdlib -I$ -I$(HL2SDK)/public/tier0 -I$(HL2SDK)/public/tier1 -I$(MMSDK)/core
